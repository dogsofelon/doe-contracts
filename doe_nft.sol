...
contract DoE is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public startindId = 101; // Presale will start at this index.

    // presale is started when this is set true.
    // Can be set false to pause presale.
    ...
    constructor() ERC721(_name, _symbol) {
        transferOwnership(msg.sender); // not needed.
    ...
    // URI will be set after the end of the initial mint, to ensure
    // a fair launch.
    ...
    // set a new client wallet to recieve claimed funds funds.
    ...
    // withdraw a specific amount of ether
